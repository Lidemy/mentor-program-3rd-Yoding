        ...
        <div class="account__info">
          <?php
            ...
            if ($result_session->num_rows > 0) {
                ...
                echo escape($row_session['nickname']);
                echo '</span>';
            } else {
                echo 'login failed';
    ...
    <!--留言板-->
      <div class="message__board">
        ...
        <form method="POST" action="./handle_add_message.php" class = "reply__section">
          ...
          <input type='hidden' value="<?php echo escape($row_session['user_id']);?>" name="user_id"/>
          <input type='hidden' value="0" name ="sub_msg_id"/>
    ...
    <!--現有留言-->
        <div class="message__section">
          ...
          while ($row = $get_content->fetch_assoc()) {
                ...
                $msg_id = $row['user_id'];
                if ($msg_id == $row_session['user_id']) {
                  renderEditOpt($msg_id);
                }
                echo "</div></div>";
            }
          }
